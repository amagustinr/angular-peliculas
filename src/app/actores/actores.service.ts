...
import { actorAutoCompleteDTO, ActorCreacionDTD, ActorDTO } from './actores';
...
export class ActoresService implements IServicioCRUD<ActorDTO,ActorCreacionDTD> {
  ...
  public actualizar(id: number, actor: ActorCreacionDTD){
