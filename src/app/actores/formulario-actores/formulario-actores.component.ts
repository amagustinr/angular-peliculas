...
@Component({
  ...
  imports: [MatButtonModule, RouterLink, MatFormFieldModule, ReactiveFormsModule, MatInputModule, MatDatepickerModule, MatMomentDateModule, InputImgComponent],
...
export class FormularioActoresComponent implements OnInit {
  ...
  @Output()
  posteoFormulario = new EventEmitter<ActorCreacionDTD>();
...
this.form.controls.foto.setValue(file);
  ...
  guardarCambios(){
    ...
    const actor = this.form.value as ActorCreacionDTD;
